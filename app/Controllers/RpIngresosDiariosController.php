...
class RpIngresosDiariosController extends BaseController
{
    private $nameClass = "RpIngresosDiariosController";
    ...
    public function index()
    {
        ...
        if (isset($_SESSION['sesion_activa']) && $_SESSION['sesion_activa'] === true) {
            ...
            if (in_array($url, $allowedUrls)) {
                ...
                $content4 = view('reportes/rpIngresosDiarios');
    ...
    public function buscarDatos()
    {
        ...
        $resultado = $rpVentasMensuales->obtenerResumenPorSucursal($fechaInicio, $fechaFin);
