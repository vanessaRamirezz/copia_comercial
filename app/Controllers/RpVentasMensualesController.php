...
class RpVentasMensualesController extends BaseController
{
    private $nameClass = "RpVentasMensualesController";
    ...
    public function index()
    {
        ...
        if (isset($_SESSION['sesion_activa']) && $_SESSION['sesion_activa'] === true) {
            ...
            if (in_array($url, $allowedUrls)) {
                ...
                $content4 = view('reportes/rpVentasMensuales', $data);
    ...
    public function buscarDatos()
    {
        ...
        log_message('debug', 'Sucursal: {sucursal}', ['sucursal' => $sucursal]);
        ...
        $resultado = $rpVentasMensuales->getReporteVentasMensuales($fechaInicio, $fechaFin, $sucursal);
