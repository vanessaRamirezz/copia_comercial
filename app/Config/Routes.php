...
$routes->group('', ['filter' => 'estadoUsuario'], function($routes) {
    ...
    $routes->post('updateEstadoUser', 'UsuariosController::actualizarEstado');//ya esta
    ...
    //Salida por nota de remision
    $routes->get('salida-nota-remision', 'IngresosController::salidaNotaRemision');

    //para ingresos y salidas
    $routes->post('procesar_ingreso', 'IngresosController::ingresar_movimiento');
    $routes->post('responderRemision', 'IngresosController::responder_remision');
    ...
    $routes->post('eliminarSolicitudContado','ContadoController::eliminarSolicitudContado');
    ...
    $routes->post('getKardex', 'KardexController::obtenerKardex');
    $routes->get('ventas-mensuales','RpVentasMensualesController::index');
    $routes->post('getVentasMensuales','RpVentasMensualesController::buscarDatos');

    $routes->get('ventas-x-vendedor','RpVentasXvendedorController::index');
    $routes->post('getVentasXvendedor','RpVentasXvendedorController::buscarDatos');

    $routes->get('ingresos-diarios','RpIngresosDiariosController::index');
    $routes->post('getDataIngresosDiarios','RpIngresosDiariosController::buscarDatos');
    ...
    $routes->get('reporte-movimientos-inventario','RpMovimientosInvetController::index');
    $routes->post('getDataMovimientosInvent','RpMovimientosInvetController::buscarDatos');
