...
class ClientesModel extends Model
{
    ...
    public function crearClienteSinDui($dui,$nombreCompleto, $telefono, $direccion, $correo)
    {
        $datos = [
            'dui' => $dui,
            'nombre_completo' => strtoupper($nombreCompleto),
            'estado_civil' => 'Soltera/o',
            'fecha_nacimiento' => '2007-06-24',
            'telefono' => $telefono,
            'direccion' => $direccion,
            'departamento' => '5',
            'municipio' => '12',
            ...
            'telefono_trabajo_conyugue' => '',
            'nombre_padres' => 'N/A',
            'direccion_padres' => 'N/A',
            'telefono_padres' => '9999-9999',
            'CpropiaCN' => 'SI',
            'CpromesaVentaCN' => 'NO',
            'CalquiladaCN' => 'NO',
            'aQuienPerteneceCN' => 'N/A',
            'telPropietarioCN' => '0000-0000',
            'tiempoDeVivirDomicilioCN' => 'N/A',
            'id_user_creacion' => 8,
            'id_sucursal_creacion' => 1,
            'duiFrontal' => null,
            'duiReversa' => null
        ];

        // El tercer parámetro `true` hace que se devuelva el insertID
