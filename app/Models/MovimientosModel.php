...
class MovimientosModel extends Model
{
    ...
    protected $allowedFields = ['id_producto', 'id_tipo_movimiento', 'cantidad', 'fecha', 'descripcion', 'id_solicitud', 'id_documento', 'id_sucursal_movimiento', 'p_contado'];
    ...
    public function getKardex($codigoProducto, $idSucursal)
    {
        ...
        FROM (
            SELECT 
                ...
                CASE WHEN tm.tipo_mov IN (3) THEN m.cantidad ELSE 0 END AS salida,
