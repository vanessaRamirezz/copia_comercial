...
class RangoFacturasModel extends Model
{
    ...
    protected $allowedFields = ['id_rango_factura', 'numero_inicio', 'numero_fin', 'id_sucursal', 'id_usuario_creador', 'fecha_creacion'];
    ...
    public function getRangoFacturas()
    {
        ...
        $builder = $this->db->table('rango_factura')
            ->select('rango_factura.*, sucursal.sucursal as nombre_sucursal, CONCAT(usuarios.nombres, " ", usuarios.apellidos) AS nombre_usuario')
