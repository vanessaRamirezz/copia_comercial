<style>
        ...
        .dataTables_wrapper .dataTable td {
            padding: 12px 15px; /* Ajustar según sea necesario */
        }
...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Ingreso por compras</h1>
        ...
        <div class="card-body ingreso_x_compra">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control form-control-sm" id="tipoMovimiento" name="tipoMovimiento" readonly disabled>
                        <option value="-1">Seleccione...</option>
                        <?php foreach ($tiposMovimientos as $tiposMovimientos) : ?>
                            <?php if ($tiposMovimientos['id_tipo_movimiento'] == 1) : ?>
                                <option selected value="<?php echo esc($tiposMovimientos['id_tipo_movimiento']); ?>"><?php echo esc($tiposMovimientos['descripcion']); ?></option>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </select>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control form-control-sm" id="sucursal" name="id_sucursal_destino">
...
<script src="<?= base_url('public/js/ingreso_x_compra.js') ?>"></script>