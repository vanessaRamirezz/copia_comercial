...
<style>
.fila-total {
    background-color: #e0f3ff !important; /* azul celeste suave */
    font-weight: bold;
}
</style>
<div class="container-fluid mt-4">
    <h1 class="h3 mb-2 text-gray-800">Reporte de Ventas mensuales</h1>
    <p class="mb-4">En este apartado podrás obtener los datos de las ventas.</p>
    ...
    <div class="table-responsive">
        <table id="tablaVentasMensuales" class="table table-bordered table-hover" style="width:100%">
...
<script src="<?= base_url('public/js/rpVentasMensuales.js') ?>"></script>