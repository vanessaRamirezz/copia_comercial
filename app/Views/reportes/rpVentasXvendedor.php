...
<div class="container-fluid mt-4">
    <h1 class="h3 mb-2 text-gray-800">Reporte de Ventas por vendedor</h1>
    <p class="mb-4">En este apartado podrás obtener los datos de las ventas por vendedor.</p>
    ...
    <form class="border p-4 rounded mb-4 bg-light">
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <select class="form-control" id="usuario" name="filtroCliente">
    ...
    <div class="table-responsive">
        <table id="tblVentasXvendedor" class="table table-bordered table-hover" style="width:100%">
...
<script src="<?= base_url('public/js/rpVentasXvendedor.js') ?>"></script>