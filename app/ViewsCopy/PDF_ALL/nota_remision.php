...
<body>
    <div class="bee-page-container">
        <h1 class="title"><?php echo esc($titulo); ?></h1><br><br>
        <table class="header-table">
            ...
            <tr>
                <td class="header-left">
                    <h3>Sucursal origen: <?php echo $documento['sucursal_origen']; ?></h3>
                </td>
                <td class="header-right">
                    <h3>Sucursal destino: <?php echo $documento['sucursal_destino']; ?></h3>
                </td>
            </tr>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="cantidad">CANTIDAD TRASLADO</th>
                    </tr>
                </thead>
                <tbody>
