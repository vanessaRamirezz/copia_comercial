...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Formato para ingresos de productos</h1>
    <div class="card shadow mb-4">
        <div class="card-body ingreso_x_compra">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control form-control-sm" id="tipoMovimiento" name="tipo_Movimiento">
                        ...
                        <?php foreach ($tiposMovimientos as $tiposMovimientos) : ?>
                            <?php if ($tiposMovimientos['id_tipo_movimiento'] > 1  && $tiposMovimientos['id_tipo_movimiento'] < 5) : ?>
                                <option value="<?php echo esc($tiposMovimientos['id_tipo_movimiento']); ?>" data-tipo-mov="<?php echo esc($tiposMovimientos['tipo_mov']); ?>"><?php echo esc($tiposMovimientos['descripcion']); ?></option>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </select>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3" id="sucursalDestinoGroup" style="display: none;">
                    <label for="sucursal_destino" class="form-label">Sucursal Destino:</label>
                    <select class="form-control form-control-sm" id="sucursal_destino" name="sucursal_destino" disabled>
                        <option value="-1">Seleccione...</option>
                        <?php foreach ($sucursales as $sucursal) : ?>
                            <option value="<?= htmlspecialchars($sucursal['id_sucursal']); ?>">
                                <?= htmlspecialchars($sucursal['sucursal']); ?>
...
<script src="<?= base_url('public/js/ingresos.js') ?>"></script>