...
<div class="container-fluid">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-9">
                                <label for="dirTrabajoConyugue">Lugar y dirección de trabajo del cónyuge</label>
    ...
    <select class="form-control" id="profesionOficio" name="profesion_oficio"
        data-descripcion="<?php echo isset($refLaboral[0]['descripcion']) ? htmlspecialchars($refLaboral[0]['descripcion']) : ''; ?>">
                            ...
                            <div class="form-group col-md-8">
                                <label for="lugarTrabajo">Patrón/Empresa/Lugar de trabajo</label>
                                <input type="text" class="form-control" id="lugarTrabajo" name="empresa" value="<?= htmlspecialchars($refLaboral[0]['empresa'] ?? ''); ?>">
                            </div>

                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="direccionDeTrabajo">Dirección del trabajo</label>
                                <input type="text" class="form-control" id="direccionDeTrabajo" name="direccion_trabajo" value="<?= htmlspecialchars($refLaboral[0]['direccion_trabajo'] ?? ''); ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label for="telTrabajo">Teléfono del trabajo</label>
                                <input type="text" class="form-control telG" id="telTrabajo" name="telefono_trabajo" value="<?= htmlspecialchars($refLaboral[0]['telefono_trabajo'] ?? ''); ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="cargoDesempeña">Cargo que desempeña</label>
                                <input type="text" class="form-control" id="cargoDesempeña" name="cargo" value="<?= htmlspecialchars($refLaboral[0]['cargo'] ?? ''); ?>">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="salario">Salario</label>
                                <input type="text" class="form-control montosG" id="salario" name="salario" value="<?= htmlspecialchars($refLaboral[0]['salario'] ?? ''); ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="tiempoDeLaborar">Tiempo de laborar en la empresa</label>
                                <input type="text" class="form-control" id="tiempoDeLaborar" name="tiempo_laborando_empresa" value="<?= htmlspecialchars($refLaboral[0]['tiempo_laborado_empresa'] ?? ''); ?>">
                            </div>
                            <div class="form-group col-md-8">
                                <label for="nombreJefe">Nombre del jefe inmediato</label>
                                <input type="text" class="form-control" id="nombreJefe" name="nombre_jefe_inmediato" value="<?= htmlspecialchars($refLaboral[0]['nombre_jefe_inmediato'] ?? ''); ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-9">
                                <label for="empresaAnterior">Empresa en que laboró anteriormente</label>
                                <input type="text" class="form-control" id="empresaAnterior" name="empresa_anterior" value="<?= htmlspecialchars($refLaboral[0]['empresa_anterior'] ?? ''); ?>">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="telEmpresaAnterior">Tel. de la empresa anterior</label>
                                <input type="text" class="form-control telG" id="telEmpresaAnterior" name="telefono_empresa_anterior" value="<?= htmlspecialchars($refLaboral[0]['telefono_empresa_anterior'] ?? ''); ?>">
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-7">
                                <label for="dirRefNoFamiliarUno">Dirección</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                <label for="telProRefNoFamiliarUno">Teléfono</label>
                            ...
                            <div class="form-group col-md-2">
                                <label for="telTrabaRefNoFamiliarUno">Teléfono trabajo</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-7">
                                <label for="dirRefNoFamiliarDos">Dirección</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                <label for="telProRefNoFamiliarDos">Teléfono</label>
                            ...
                            <div class="form-group col-md-2">
                                <label for="telTrabaRefNoFamiliarDos">Teléfono trabajo</label>
                            ...
                            <div class="col-sm">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php for ($i = 0; $i < 3; $i++): ?>
                                            <tr>
                                                <td><input type="text" class="form-control" id="refCrediticiaNombre<?= $i + 1 ?>" name="institucion<?= $i + 1 ?>" value="<?= isset($refCrediticia[$i]['institucion']) ? htmlspecialchars($refCrediticia[$i]['institucion']) : '' ?>"></td>
                                                <td><input type="text" class="form-control telG" id="refCrediticiaTel<?= $i + 1 ?>" name="telefono<?= $i + 1 ?>" value="<?= isset($refCrediticia[$i]['telefono']) ? htmlspecialchars($refCrediticia[$i]['telefono']) : '' ?>"></td>
                                                <td><input type="text" class="form-control montosG" id="refCrediticiaMonto<?= $i + 1 ?>" name="monto_credito<?= $i + 1 ?>" value="<?= isset($refCrediticia[$i]['monto_credito']) ? htmlspecialchars($refCrediticia[$i]['monto_credito']) : '' ?>"></td>
                                                <td><input type="text" class="form-control" id="refCrediticiaPeriodo<?= $i + 1 ?>" name="periodos<?= $i + 1 ?>" value="<?= isset($refCrediticia[$i]['periodos']) ? htmlspecialchars($refCrediticia[$i]['periodos']) : '' ?>"></td>
                                                <td><input type="text" class="form-control" id="refCrediticiaPlazo<?= $i + 1 ?>" name="plazo<?= $i + 1 ?>" value="<?= isset($refCrediticia[$i]['plazo']) ? htmlspecialchars($refCrediticia[$i]['plazo']) : '' ?>"></td>
                                                <td>
                                                    <div class="form-group col-md">
                                                        <select id="refCrediticiaEstado<?= $i + 1 ?>" class="form-control" name="estado<?= $i + 1 ?>">
                                                            <option value="ACTIVA" <?= (isset($refCrediticia[$i]['estado']) && $refCrediticia[$i]['estado'] == 'ACTIVA') ? 'selected' : '' ?>>ACTIVA</option>
                                                            <option value="CANCELADA" <?= (isset($refCrediticia[$i]['estado']) && $refCrediticia[$i]['estado'] == 'CANCELADA') ? 'selected' : '' ?>>CANCELADA</option>
                                                        </select>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <div class="col-sm">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="valorArticulo" name="valorArticulo" disabled>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="pagoPrima">Valor/pago de prima</label>
                                                <input type="text" class="form-control montosG" id="valorPagoPrima" name="valorPagoPrima">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="saldoAPagar">Saldo a pagar</label>
                                                <input type="text" class="form-control" id="saldoAPagar" name="saldoAPagar" disabled>
                                            </div>
                                        </div>
                                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-10">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre"
                                    value="<?php echo isset($codeudor[0]['nombre']) ? htmlspecialchars($codeudor[0]['nombre']) : ''; ?>">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="dui">DUI:</label>
                                <input type="text" class="form-control duiG" id="dui" name="dui"
                                    value="<?php echo isset($codeudor[0]['dui']) ? htmlspecialchars($codeudor[0]['dui']) : ''; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="direccion">Dirección:</label>
                            <input type="text" class="form-control" id="direccion" name="direccion"
                                value="<?php echo isset($codeudor[0]['direccion']) ? htmlspecialchars($codeudor[0]['direccion']) : ''; ?>">
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control telG" id="COtelPersonal"
                                    value="<?php echo isset($codeudor[0]['telefono_personal']) ? htmlspecialchars($codeudor[0]['telefono_personal']) : ''; ?>">
                            </div>

                            <div class="form-group col-md-3">
    <label for="COpropiaCN">Vive en casa propia</label>
    <select id="COpropiaCN" class="form-control">
        <option value="-1" <?php echo (isset($codeudor[0]['vive_en_casa_propia']) && $codeudor[0]['vive_en_casa_propia'] == '' ? 'selected' : ''); ?>>Seleccione...</option>
        <option value="SI" <?php echo (isset($codeudor[0]['vive_en_casa_propia']) && $codeudor[0]['vive_en_casa_propia'] == 'si' ? 'selected' : ''); ?>>SI</option>
        <option value="NO" <?php echo (isset($codeudor[0]['vive_en_casa_propia']) && $codeudor[0]['vive_en_casa_propia'] == 'no' ? 'selected' : ''); ?>>NO</option>
    </select>
</div>
<div class="form-group col-md-3">
    <label for="COpromesaVenta">o en promesa de venta</label>
    <select id="COpromesaVenta" class="form-control">
        <option value="-1" <?php echo (isset($codeudor[0]['en_promesa_de_venta']) && $codeudor[0]['en_promesa_de_venta'] == '' ? 'selected' : ''); ?>>Seleccione...</option>
        <option value="SI" <?php echo (isset($codeudor[0]['en_promesa_de_venta']) && $codeudor[0]['en_promesa_de_venta'] == 'si' ? 'selected' : ''); ?>>SI</option>
        <option value="NO" <?php echo (isset($codeudor[0]['en_promesa_de_venta']) && $codeudor[0]['en_promesa_de_venta'] == 'no' ? 'selected' : ''); ?>>NO</option>
    </select>
</div>
<div class="form-group col-md-2">
    <label for="COalquilada">Alquilada</label>
    <select id="COalquilada" class="form-control">
        <option value="-1" <?php echo (isset($codeudor[0]['alquilada']) && $codeudor[0]['alquilada'] == '' ? 'selected' : ''); ?>>Seleccione...</option>
        <option value="SI" <?php echo (isset($codeudor[0]['alquilada']) && $codeudor[0]['alquilada'] == 'si' ? 'selected' : ''); ?>>SI</option>
        <option value="NO" <?php echo (isset($codeudor[0]['alquilada']) && $codeudor[0]['alquilada'] == 'no' ? 'selected' : ''); ?>>NO</option>
    </select>
</div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control" id="COtiempoVivienda"
                                    value="<?php echo isset($codeudor[0]['tiempo']) ? htmlspecialchars($codeudor[0]['tiempo']) : ''; ?>">
                            </div>
    ...
    <option value="-1" <?php echo (isset($codeudor[0]['estado_civil']) && $codeudor[0]['estado_civil'] == '' ? 'selected' : ''); ?>>Seleccione...</option>
    <option value="Soltera/o" <?php echo (isset($codeudor[0]['estado_civil']) && $codeudor[0]['estado_civil'] == 'Soltera/o' ? 'selected' : ''); ?>>Soltera/o</option>
    <option value="Casada/o" <?php echo (isset($codeudor[0]['estado_civil']) && $codeudor[0]['estado_civil'] == 'Casada/o' ? 'selected' : ''); ?>>Casada/o</option>
    <option value="Acompañada/o" <?php echo (isset($codeudor[0]['estado_civil']) && $codeudor[0]['estado_civil'] == 'Acompañada/o' ? 'selected' : ''); ?>>Acompañada/o</option>
    <option value="Viuda/o" <?php echo (isset($codeudor[0]['estado_civil']) && $codeudor[0]['estado_civil'] == 'Viuda/o' ? 'selected' : ''); ?>>Viuda/o</option>
</select>
                            ...
                            <div class="form-group col-md-9">
                                ...
                                <input type="text" class="form-control" id="nombreConyugueCN"
                                    value="<?php echo isset($codeudor[0]['nombre_conyugue']) ? htmlspecialchars($codeudor[0]['nombre_conyugue']) : ''; ?>">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="profesion" name="profesion"
                                    value="<?php echo isset($codeudor[0]['profesion_oficio']) ? htmlspecialchars($codeudor[0]['profesion_oficio']) : ''; ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="patrono">Patrono/Empresa/Lugar de Trabajo:</label>
                                <input type="text" class="form-control" id="patrono" name="patrono"
                                    value="<?php echo isset($codeudor[0]['patrono_empresa']) ? htmlspecialchars($codeudor[0]['patrono_empresa']) : ''; ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-9">
                                ...
                                <input type="text" class="form-control" id="COdireccionTrabajo" name="COdireccionTrabajo"
                                    value="<?php echo isset($codeudor[0]['direccion_trabajo']) ? htmlspecialchars($codeudor[0]['direccion_trabajo']) : ''; ?>">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="COtelefonoTrabajo">Teléfono Trabajo:</label>
                                <input type="text" class="form-control telG" id="COtelefonoTrabajo" name="COtelefonoTrabajo"
                                    value="<?php echo isset($codeudor[0]['telefono_trabajo']) ? htmlspecialchars($codeudor[0]['telefono_trabajo']) : ''; ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="COcargoDesempeña" name="COcargoDesempeña"
                                    value="<?php echo isset($codeudor[0]['cargo']) ? htmlspecialchars($codeudor[0]['cargo']) : ''; ?>">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="COsalario">Salario:</label>
                                <input type="text" class="form-control montosG" id="COsalario" name="COsalario"
                                    value="<?php echo isset($codeudor[0]['salario']) ? htmlspecialchars($codeudor[0]['salario']) : ''; ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="COnombreJefe">Nombre Jefe inmediato:</label>
                                <input type="text" class="form-control" id="COnombreJefe" name="COnombreJefe"
                                    value="<?php echo isset($codeudor[0]['nombre_jefe_inmediato']) ? htmlspecialchars($codeudor[0]['nombre_jefe_inmediato']) : ''; ?>">
                            </div>
                        </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-10">
                                        ...
                                        <input type="text" class="form-control coref1" id="COdireccionRef1" name="COdireccionRef1"
                                            value="<?php echo isset($refCodeudor[0]['direccion']) ? htmlspecialchars($refCodeudor[0]['direccion']) : ''; ?>" required>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="COtelRef1">Teléfono:</label>
                                        <input type="text" class="form-control coref1 telG" id="COtelRef1" name="COtelRef1"
                                            value="<?php echo isset($refCodeudor[0]['telefono']) ? htmlspecialchars($refCodeudor[0]['telefono']) : ''; ?>"
                                            pattern="^\d{8}$" title="El teléfono debe tener 8 dígitos" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-10">
                                        ...
                                        <input type="text" class="form-control coref2" id="COnombreRef2" name="COnombreRef2"
                                            value="<?php echo isset($refCodeudor[1]['nombre']) ? htmlspecialchars($refCodeudor[1]['nombre']) : ''; ?>" required>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-10">
                                        ...
                                        <input type="text" class="form-control coref2" id="COdireccionRef2" name="COdireccionRef2"
                                            value="<?php echo isset($refCodeudor[1]['direccion']) ? htmlspecialchars($refCodeudor[1]['direccion']) : ''; ?>" required>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="COtelRef2">Teléfono:</label>
                                        <input type="text" class="form-control coref2 telG" id="COtelRef2" name="COtelRef2"
                                            value="<?php echo isset($refCodeudor[1]['telefono']) ? htmlspecialchars($refCodeudor[1]['telefono']) : ''; ?>" pattern="^\d{8}$" title="El teléfono debe tener 8 dígitos" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-10">
                                        ...
                                        <input type="text" class="form-control coref3" id="COnombreRef3" name="COnombreRef3"
                                            value="<?php echo isset($refCodeudor[2]['nombre']) ? htmlspecialchars($refCodeudor[2]['nombre']) : ''; ?>" required>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-10">
                                        ...
                                        <input type="text" class="form-control coref3" id="COdireccionRef3" name="COdireccionRef3"
                                            value="<?php echo isset($refCodeudor[2]['direccion']) ? htmlspecialchars($refCodeudor[2]['direccion']) : ''; ?>" required>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="COtelRef3">Teléfono:</label>
                                        <input type="text" class="form-control coref3 telG" id="COtelRef3" name="COtelRef3"
                                            value="<?php echo isset($refCodeudor[2]['telefono']) ? htmlspecialchars($refCodeudor[2]['telefono']) : ''; ?>"
                                            pattern="^\d{8}$" title="El teléfono debe tener 8 dígitos" required>
                                    </div>
                                </div>
