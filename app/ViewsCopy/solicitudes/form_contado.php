...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Comprar al contado</h1>
    <p class="mb-4">En este formulario podra realizar la factura de la compra al contado</p>
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-4"><input type="text" id="detalleIdSolicitud" hidden></div>
                    ...
                    <div class="col-md-4"><strong>Tipo:</strong> <span id="detalleTipoSolicitud"></span></div>
                </div>
                <div class="row mb-3">
